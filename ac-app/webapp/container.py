...
class Container(containers.DeclarativeContainer):
    ...
    scraping_service_factory = providers.FactoryAggregate(
        manhuaren=providers.Singleton(
            ManhuarenScrapingService, download_service=download_service
        ),
        copymanga=providers.Singleton(
            CopyMangaScrapingService, download_service=download_service
        ),
        anime1=providers.Singleton(
            Anime1ScrapingService, download_service=download_service
        ),
    )
